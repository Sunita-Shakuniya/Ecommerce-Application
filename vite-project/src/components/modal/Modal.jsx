        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="focus:outline-none text-white  rounded hover:bg-pink-700  font-medium rounded-lg text-sm w-full py-2"style={{background:'linear-gradient(to top,#0a3d9f, rgb(4 33 89))'}}
                >
                    Buy Now
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none text-white  hover:blue-700  font-medium rounded-lg text-sm w-full py-2"style={{background:'linear-gradient(to top,#0a3d9f, rgb(4 33 89))'}}>Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
